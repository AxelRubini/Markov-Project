...
static void test_ht_table_basic(void) {
  ...
  free_hash_table(ht, free_ht_item);
}
/*
/* -----------------------------------------------------
 * Word‑follower hash‑table tests
 * -----------------------------------------------------*/
static void test_word_followers_hash_table(void) {
  hash_table_t *ht = create_hash_table(101, word_hash, str_cmp);
...
int main(void) {
  ...
  /* Uncomment to test ht_item update behaviour directly */
